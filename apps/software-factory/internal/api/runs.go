...
type attemptOutput struct {
	...
	FailureKind       string          `json:"failureKind" enum:",invalid_input,agent_unrecoverable,ci_unobserved,github_auth,github_ruleset,github_unavailable,run_worker_unavailable,persistence_unavailable,infrastructure" doc:"The terminal failure category, empty unless this Attempt failed."`
...
type runOutput struct {
	...
	FailureKind    string                `json:"failureKind" enum:",invalid_input,agent_unrecoverable,ci_unobserved,github_auth,github_ruleset,github_unavailable,run_worker_unavailable,persistence_unavailable,semantic_deadline,infrastructure" doc:"The target Run failure category. Empty when not failed."`
