...
func TestNewPromptRendererRendersEveryStageOfThePipeline(t *testing.T) {
	...
	// Every prior stage's document, so any stage can be rendered. What this
	...
	prior := map[work.Stage]string{
		...
		work.StageReview:    "the review",
		work.StageRevise:    "the revised plan",
		work.StageImplement: "the implementation report",
	}
