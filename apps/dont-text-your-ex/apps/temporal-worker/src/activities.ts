...
import { createMonthlyRecapActivities, type MonthlyRecapStore } from "./monthly-recaps";
...
export type DtyeActivityDependencies = Readonly<{
  ...
  monthlyRecaps: MonthlyRecapStore;
  clock?: () => number;
}>;
...
export function createDtyeActivities(dependencies: DtyeActivityDependencies) {
  ...
  return {
    ...
    ...dependencies.rescue,
    ...createMonthlyRecapActivities(dependencies.monthlyRecaps),
  };
}
