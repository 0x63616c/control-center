/**
 * The booth feature's own Postgres handle (Track C, final tile fold). The
 * feature builds its db from its own {@link config} slice and the shared
 ...
 * (api.ts, http.ts) — is side-effect free enough for the codegen to load.
 */
