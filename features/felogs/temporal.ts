...
/**
 * The Temporal facet (ADR-0008): the daily frontend-log retention purge, migrated
 * from the S2 k8s CronJob seam (`felogs purge cron`). Same cadence, now with
...
export const temporal = defineTemporal({
  workflowTypes: ["FelogsPurgeWorkflow"],
  schedules: [
    {
      id: "purge",
