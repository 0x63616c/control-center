...
export const featureAppRouter = mergeRouters(acApi, boothApi, ctrlApi, deploysApi, dogcamApi, eventsApi, felogsApi, goalsApi, guestWifiApi, injectionsApi, networkApi, notifApi, scenesApi, soundApi, teslaApi, tvApi, wakesApi, weatherApi, weightApi);
