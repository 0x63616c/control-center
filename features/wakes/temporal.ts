...
/**
 * The Temporal facet (ADR-0008): the daily wake-photo retention purge, migrated
 * from the S2 k8s CronJob seam (`wakes purge cron`). Same cadence, now with
...
export const temporal = defineTemporal({
  workflowTypes: ["WakesPurgeWorkflow"],
  schedules: [
    {
      id: "purge",
